...
<div class="sidenav">
  ...
  <a  href="#home"> <i class="glyphicon glyphicon-home" style="font-size:15px; color:#;#939393;">&nbsp;Yard Management</i> </a>
  <a  href="#home"> <i class="glyphicon glyphicon-user" style="font-size:15px; color:#;#939393;">&nbsp;User Statics</i> </a>
...
<div class="topnav">
	<span><a  href="#home"> <i class="glyphicon glyphicon-user" style="font-size:20px;color:#;#939393;">User </i> </a></span>
	...
	<div style="float: right ">
	 <span><a  href="#home"> <i class="glyphicon glyphicon-log-out" style="font-size:20px;color:#;#939393;">LogOut</i></a></span>
	</div>
...
<div style="padding-left:22%">
    ...
    <tr>
      ...
      <td width="511"><img src="manageuser.png" width="283" height="276" alt=""/></td>
    </tr>
    <tr>
